    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body border">
                <div class="card">
                    <form class="form-horizontal" action="{{route('admin_category_update',['id'=>$data->id])}}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row" data-select2-id="12">
                                ...
                                <div class="col-md-9" data-select2-id="11">
                                    <select name="parent_id" class="select2 form-control custom-select select2-hidden-accessible" style="width: 100%; height:36px;" " tabindex="-1" aria-hidden="true">
                                        <option value="0" data-select2-id="3">Main Category</option>
                            ...
                            <div class="form-group row" data-select2-id="12">
                                ...
                                <div class="col-md-9" data-select2-id="11">
                                    <select value="{{$data->status}}" name="status" class="select2 form-control custom-select select2-hidden-accessible" style="width: 100%; height:36px;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        <!-- <option data-select2-id="3" @if($data->status =='False') selected="selected" @endif >{{$data->status}}</option> -->
