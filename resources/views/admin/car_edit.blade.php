                        ...
                        <form class="form-horizontal" action="{{ route('admin_car_update', ['id' => $data->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->brand }}" type="text" name="brand" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->price }}"  type="number" name="price" class="form-control" id="price"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->year }}" type="text" name="year" class="form-control"
                                ...
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-2 text-right control-label col-form-label">Engine
                                        Power</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $data->engine_power }}" type="number" name="engine_power"
                                ...
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-2 text-right control-label col-form-label">Fuel
                                        Type</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $data->fuel_type }}" type="text" name="fuel_type"
                                ...
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-2 text-right control-label col-form-label">Licance
                                        Plate</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $data->licance_plate }}" type="text" name="licance_plate"
                                ...
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-2 text-right control-label col-form-label">Gear
                                        Type</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $data->gear_type }}" type="text" name="gear_type"
                                ...
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-2 text-right control-label col-form-label">Brand
                                        ID</label>
                                    <div class="col-sm-9">
                                        <input value="{{ $data->brand_id }}" type="text" name="brand_id" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ $data->slug }}" type="text" name="slug" class="form-control" id="slug"
