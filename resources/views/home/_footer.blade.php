                    ...
                    <div class="footer-widget widget-about">
                        <div class="widget-about-content">
                            <a href="index.html" class="footer-logo"><img style="    border: 1px solid red;border-radius: 100%;" src="{{asset('assets')}}/images/logo-footer.png"
                                    alt="logo"></a>
                            <p>إيجار ذو فرص واعدة ويستحق المجازفة نظر ا للطلب الكبير في السوق، وللدعم
الحكومي مع قلة المنافسين في هذا المجال خصوصاأنه يتميز عن المنافسين
بإيصال السيارة للعميل في أي يوم وفي أي وقت أما السيارات التجارية في أي يوم وأي
وقت أثناء أوقات عمل الشركة المُعلنة في اعلان الشركة نظرا لاعتماده على الموقع والتطبيق، بالإضافة إلى النمو السكاني، وتحسن
